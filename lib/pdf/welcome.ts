...
.hero-greeting{font-size:11px;color:#00D4AA;letter-spacing:3px;text-transform:uppercase;font-weight:700;margin-bottom:12px}
...
.check-dot{width:20px;height:20px;background:rgba(0,212,170,0.15);border:1.5px solid #00D4AA;border-radius:50%;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:10px;color:#00D4AA;font-weight:700;margin-top:2px}
.action-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-bottom:28px}
.action-card{background:#f8f9ff;border-radius:10px;padding:16px;border-top:3px solid #00D4AA;text-align:center}
.action-card .step{font-size:10px;color:#00D4AA;font-weight:700;letter-spacing:1px;text-transform:uppercase;margin-bottom:4px}
...
.sign-off{text-align:center;margin-top:32px;padding:20px;background:#f0fff9;border-radius:10px;border:1px solid #c0f0e0}
...
<div class="body">
  ...
  <div class="contact-box">
    <div>
      ...
      <div class="contact-item">Email: <span style="color:#00D4AA">hello@autonexai.org</span></div>
      <div class="contact-item">Website: <span style="color:#00D4AA">autonexai.org</span></div>
      <div class="contact-item">Location: <span style="color:#00D4AA">Hyderabad, India</span></div>
    </div>
    <div style="text-align:right">
      <div style="font-size:11px;color:#00D4AA;font-weight:700;letter-spacing:1px;text-transform:uppercase;margin-bottom:6px">Response Time</div>
  ...
  <div class="sign-off" style="margin-top:28px">
    ...
    <p style="font-size:17px;font-weight:800;color:#00D4AA;margin-top:6px">The Autonex AI Team</p>
